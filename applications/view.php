...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-4">
        <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 mb-3">
            <div><h2 class="h5 mb-1">Financial ratios summary</h2><p class="text-secondary small mb-0">Comparative ratio table across all financial periods for this application. For MVP, DSCR is calculated as EBITDA divided by the estimated annual debt service amount for the requested loan.</p></div>
